...
class Trainer():
    ...
    def __call__(self):
        ...
        self.model = vn_DeepSDF.SDFModel(
        ...
        self.latent_codes = generate_latent_codes(self.train_cfg['latent_size'], samples_dict)
        ...
        file_name =os.path.join(self.run_dir, 'Loss.txt')
        ...
        for epoch in range(self.train_cfg['epochs']):
            ...
            with open(file_name, 'w') as file:
                ...
                file.write(f'Validation: loss {avg_val_loss}')
                ...
                if avg_val_loss < best_loss:
                    ...
                    print(os.path.join(self.run_dir, 'weights.pt'))
